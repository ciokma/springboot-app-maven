...
pipeline {
    ...
    stages {
	  ...
	  steps {
	    nexusArtifactUploader artifacts: [[artifactId: '01-spring-app', classifier: '', file: 'target/spring-app-0.0.1-SNAPSHOT.jar', type: 'jar']], credentialsId: 'nexus-credentials', groupId: 'spring-app', nexusUrl: 'http://54.147.37.68:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'spring-ms-app', version: '${currentBuild.number}-INITIAL'
	  }
       }
